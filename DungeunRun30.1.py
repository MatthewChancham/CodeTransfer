...
SKILL_TREES = {
    'Warrior': [
        ...
        {'name': 'Fist Blast',              'tier': 3, 'prereq': ['Ground Pound'],          'cost': 3, 'type': 'active',  'desc': 'A powerful forward fist blast dealing heavy damage.',           'branch': 'left',   'passive': None},
        {'name': 'Lingering Aura of Valour','tier': 4, 'prereq': ['Fist Blast'],            'cost': 6, 'type': 'active',  'desc': 'Radiate a damaging aura that also blocks enemy projectiles.',   'branch': 'left',   'passive': None},
    ...
    'Mage': [
        ...
        {'name': 'Fireball',                'tier': 2, 'prereq': ['Mana Bolt'],             'cost': 7, 'type': 'active',  'desc': 'Explosive fireball — deals AoE fire damage on impact.',         'branch': 'left',   'passive': None},
        {'name': 'Icicle',                  'tier': 3, 'prereq': ['Fireball'],              'cost': 5, 'type': 'active',  'desc': 'Ice spike that shatters on impact with frost AoE.',             'branch': 'left',   'passive': None},
        {'name': 'Chain Lightning',         'tier': 4, 'prereq': ['Icicle'],                'cost': 5, 'type': 'active',  'desc': 'Lightning bolt that chains between up to 5 enemies.',           'branch': 'left',   'passive': None},
        ...
        {'name': 'Mana Bubble',             'tier': 3, 'prereq': ['Arcane Mind'],           'cost': 5, 'type': 'active',  'desc': 'Toggle a mana-powered shield that repels enemies and projectiles.', 'branch': 'right', 'passive': None},
    ...
    'Rogue': [
        ...
        {'name': 'Blink',                   'tier': 3, 'prereq': ['Shadow Dagger'],         'cost': 5, 'type': 'active',  'desc': 'Teleport a great distance toward the nearest enemy.',           'branch': 'left',   'passive': None},
        {'name': 'Thousand Cuts',           'tier': 4, 'prereq': ['Blink'],                 'cost': 5, 'type': 'active',  'desc': 'Unleash a rapid flurry of slashes on a single target.',         'branch': 'left',   'passive': None},
    ...
    'Cleric': [
        ...
        {'name': 'Light Beam',              'tier': 3, 'prereq': ['Minor Heal'],            'cost': 4, 'type': 'active',  'desc': 'Summon a rotating beam of holy light for 3 seconds.',           'branch': 'left',   'passive': None},
        {'name': 'Summon Range Sentry',     'tier': 4, 'prereq': ['Light Beam'],            'cost': 3, 'type': 'active',  'desc': 'Summon a sentry that fires holy bolts at all enemies.',         'branch': 'left',   'passive': None},
    ...
    'Druid': [
        ...
        {'name': 'Leaf Shot',               'tier': 3, 'prereq': ['Summon Wolf'],           'cost': 3, 'type': 'active',  'desc': 'Fire a barrage of razor-sharp leaves at an enemy.',             'branch': 'left',   'passive': None},
    ...
    'Ranger': [
        ...
        {'name': 'Fire Trap',               'tier': 3, 'prereq': ['Multishot'],             'cost': 5, 'type': 'active',  'desc': 'Place a fire trap that ignites enemies on contact.',            'branch': 'left',   'passive': None},
        {'name': 'Frost Trap',              'tier': 4, 'prereq': ['Fire Trap'],             'cost': 4, 'type': 'active',  'desc': 'Place a frost trap that freezes and slows enemies.',            'branch': 'left',   'passive': None},
    ...
    def update(self, dt, game):
        ...
        # --- add this inside Particle.update() ---
            ...
            if self.owner == "player":
                ...
                for e in list(game.room.enemies):
                    if distance((self.x, self.y), (e.x, e.y)) <= self.size:
                        game.damage_enemy(e, self.damage or game.player.mag * 0.005)
            elif self.owner == "enemy":
                # damage player
                if distance((self.x, self.y), (game.player.x, game.player.y)) <= self.size:
