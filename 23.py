...
class Player:
    ...
    def __init__(self,name='Hero',class_name='Warrior'):
        ...
        self.stat_points=5; self.skill_points=1; self.gen_skill_points=0
    ...
    def populate_skills(self):
        ...
        if self.class_name=='Mage':
            ...
            def wild_shape_skill(player, game):
                """Toggle Wild Shape form hotbar, or exit current form."""
                if getattr(player, 'wild_shape_form', None):
                    game.exit_wild_shape()
                    game._ws_hotbar_active = False
                else:
                    game._ws_hotbar_active = not getattr(game, '_ws_hotbar_active', False)
