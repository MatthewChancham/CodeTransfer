...
class GameFrame(tk.Frame):
    ...
    def draw_stats_panel(self):
        ...
        self.canvas.create_rectangle(100, 100, 700, 500, fill='gray', outline='white', width=4)
        ...
        for i, stat in enumerate(stats):
            ...
            self.canvas.create_rectangle(120, y, 580, y + 30, fill='black', outline='white')
            ...
            if p.stat_points > 0:
                self.canvas.create_rectangle(600, y, 630, y + 30, fill='black', outline='white')
